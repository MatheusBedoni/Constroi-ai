...
public class PedidoOrcamentoEncanadorDois extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_orcamento_encanador_dois);
    ...
    protected void onResume() {
        ...
        aSwitch3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                registros += "Mau funcionamento da torneira\n";
            }
