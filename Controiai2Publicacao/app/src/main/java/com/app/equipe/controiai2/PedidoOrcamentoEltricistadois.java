...
public class PedidoOrcamentoEltricistadois extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pedido_orcamento_eltricistadois);
        ...
        aSwitch13 = (Switch)findViewById(R.id.switch14);
        aSwitch14 = (Switch)findViewById(R.id.switch15);
        aSwitch15 = (Switch)findViewById(R.id.switch16);
        aSwitch16 = (Switch)findViewById(R.id.switch17);
        aSwitch17 = (Switch)findViewById(R.id.switch18);
        aSwitch18 = (Switch)findViewById(R.id.switch19);
    ...
    protected void onResume() {
        ...
        aSwitch14.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                registros += "Resistência de chuveiro\n";
            }
        ...
        aSwitch18.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                registros += "Instalação de eletrodoméstico\n";
            }
