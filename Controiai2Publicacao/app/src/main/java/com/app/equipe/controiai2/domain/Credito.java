...
public class Credito {
    ...
    public String getCkproprietario() {
        return ckproprietario;
    }
    ...
    public void setCkproprietario(String ckproprietario) {
        this.ckproprietario = ckproprietario;
    }
